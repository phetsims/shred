...
/**
 * ShredData contains data tables related to the elements, such as their names, symbols, and stable isotopes.
 *
...
// present on Earth.
export const TRACE_ABUNDANCE = 0.000000000001;
...
export const stableElementTable = [
  // No element
  [],
  // Hydrogen
  [ 0, 1 ],
...
export const numNeutronsInMostStableIsotope = [
  // No element
  0,
  // Hydrogen
  0,
...
export const mapElectronCountToRadius: Record<number, number> = {
  1: 53,
  2: 31,
  3: 167,
  4: 112,
...
export const DECAYS_INFO_TABLE: DecaysInfo = {
  0: {
    1: {
      'B-': 100
    },
...
export const standardMassTable = [
  0, // 0, NO ELEMENT
  1.00794, // 1, HYDROGEN
  4.002602, // 2, HELIUM
  6.941, // 3, LITHIUM
...
export const HalfLifeConstants: HalfLifeConstantsType = {
  0: {
    1: 613.9,
    4: 1.75476E-22,
    6: null
